...
if (isset($_POST['kirim'])) {
    ...
    if (move_uploaded_file($tmp, 'gambar/'.$gambar_baru)) {
        ...
        $result = mysqli_query($db, "INSERT INTO pendaftaran_bisnis (pemilik_bisnis, nama_bisnis, telpon, alamat, email, jenis_bisnis, dokumen) VALUES ('$pemilik_bisnis', '$nama_bisnis', '$telpon', '$alamat', '$email', '$jenis_bisnis', '$gambar_baru')");
...
<body border="1" align="center">
    <div class="backround">
        ...
        <div style="display: flex; align-items: center; flex-direction: column;">
            ...
            <div class="box"><br>
                <form action="daftar_bisnis.php" method="post" enctype="multipart/form-data">
                    ...
                    <br>
                    <label class="custom" for="dokumen">Upload Dokumen : </label>
